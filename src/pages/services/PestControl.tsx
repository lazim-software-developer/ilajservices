...
const PestControl = () => {
  ...
  const mainService = {
    ...
    image: "https://images.unsplash.com/photo-1572020525351-3ca5c5962200?w=800&h=400&fit=crop",
    features: [
      ...
      "Treatment for all common pests"
    ],
    benefits: [
      ...
      <div className="container mx-auto px-4">
        ...
        <Breadcrumb className="mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Pest Control</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="bg-gradient-primary rounded-2xl text-white p-8 lg:p-12 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Book your {mainService.name} service today and enjoy a pest-free environment 
            with our professional treatment and guarantee.
          </p>
