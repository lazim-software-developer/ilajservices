...
const BathroomDeepCleaningService = () => {
  ...
  const mainService = {
    ...
    benefits: [
      ...
      "Removes stubborn mold", 
      "Sparkling clean fixtures",
      "Fresh, hygienic bathroom"
    ]
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <Breadcrumb className="mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Bathroom Deep Cleaning</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="bg-gradient-primary rounded-2xl text-white p-8 lg:p-12 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Book your {mainService.name} service today and enjoy a spotless, 
            sanitized bathroom with our professional deep cleaning treatment.
          </p>
...
export default BathroomDeepCleaningService;