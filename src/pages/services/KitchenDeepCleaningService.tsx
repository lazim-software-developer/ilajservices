...
const KitchenDeepCleaningService = () => {
      ...
      <div className="container mx-auto px-4">
        ...
        <Breadcrumb className="mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Kitchen Deep Cleaning</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="bg-gradient-primary rounded-2xl text-white p-8 lg:p-12 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            ...
            hygienic kitchen with our professional deep cleaning.
          </p>
...
export default KitchenDeepCleaningService;